    ...
    class CollectibleChanges
    {
        ...
        static bool GoldenTickSpell_CastSpell(GoldenTickSpell __instance, ref bool __result)
        {
            ...
            for (int i = 0; i < __instance.app.model.characterSheet.spells.Count; i++)
            {
                ...
                {
                    int costReduction = CollectibleStatistics.CalculateManaCostReduction(spellElement, CollectibleStatistics.SpellManaCostReductionPercentage(SpellName.GoldenTick), true);
        ...
        static bool SleightOfHandSpell_CastSpell(SleightOfHandSpell __instance, ref bool __result)
        {
            ...
            for (int i = 0; i < __instance.app.model.characterSheet.spells.Count; i++)
            {
                ...
                {
                    int costReduction = CollectibleStatistics.CalculateManaCostReduction(spellElement, CollectibleStatistics.SpellManaCostReductionPercentage(SpellName.SleightOfHand), true);
        ...
        {
            if (__instance.app.model.characterSheet.hitPoints + __instance.app.model.characterSheet.soulHearts >= 1f) return true;
            return false;
        }
