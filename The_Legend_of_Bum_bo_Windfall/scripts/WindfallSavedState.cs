...
namespace The_Legend_of_Bum_bo_Windfall
{
    public static class WindfallSavedState
    {
        ...
        public static bool LoadShop(Shop __instance, TrinketModel ___trinketModel)
        {
            ...
            //Load shop
            if (windfallDoc == null) return false;
            ...
            if (gamblingNode != null)
            {
                ...
                for (int i = 0; i < pickupNodeList.Count; i++)
                {
                    ...
                    else if (type == "trinket")
                    {
                        ...
                        {
                            if (___trinketModel == null) ___trinketModel = __instance.gameObject.AddComponent<TrinketModel>();
                        }
                ...
                {
                    if (__instance.GetPickup(index) != null) __instance.GetPickup(index).GetComponent<TrinketPickupView>().shopIndex = index;
                }
                return true;
            }
